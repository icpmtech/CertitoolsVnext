...
public class PlanUtils {
    ...
    /**
     * Calculates the depth of a Folder based on the path (counts '/') /certitools_pei_root/PEI16/offline/Secção 1
     * returns 1 /certitools_pei_root/PEI16/offline/Secção 1/folders/sub returns 2 /certitools_pei_root/PEI16/offline/Secção
